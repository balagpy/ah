...
class TeamUsersController < ApplicationController
  ...
  def create
    ...
    if @team_user.save(context: :invite)
      redirect_to(user_team_users_path(@team), notice: "Invitation successful.")
    else
      render action: "new"
    end
  end
  ...
  def destroy
    @team_user.destroy
    redirect_to(user_team_users_path(@team), notice: "Removed successfully.")
  end
  ...
  def accept
    @team_user.accepted!
    redirect_to(user_team_users_path(@team), notice: "Accepted successfully and joined the organization.")
  end

  def reject
    @team_user.destroy
    redirect_to(user_team_users_path(@team), notice: "Successfully rejected.")
  end
